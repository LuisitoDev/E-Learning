...
class Mensajes_Model implements JsonSerializable {
    ...
    public function getFechaCreacionConFormatoMensaje()
    {
        ...
        $dateCorrect =  date('Y-m-d H:i:s', strtotime('-6 hours', strtotime($this->FechaCreacionMensaje)));
        ...
        $dt = DateTime::createFromFormat("Y-m-d H:i:s", $dateCorrect);
        $hours = $dt->format('H:i'); 

        return strtoupper($myFormatDate) . " " . $hours;
    }
