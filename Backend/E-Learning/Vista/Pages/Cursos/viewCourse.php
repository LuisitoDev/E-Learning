            ...
            <div class="row bg-white p-3 border border-1 ">
              ...
              <?php if ($validacionesGenerales->getUsuarioPuedeVerNiveles() || ($iNivelCurso->getNivelGratis() == 1 && $validacionesGenerales->isUsuarioEscuela() == false)) :  ?>
                <div class="col-4 d-flex align-items-center justify-content-center">
                  <a href="<?php echo Template::Route(CursosController::ROUTE, CursosController::NIVELES_DEL_CURSO . "/" . $iNivelCurso->getCursoImpartido() . "/" . $iNivelCurso->getIdNivel()); ?>" class="btn btn-active-color" style="font-size: 1.1rem;">Ver video</a>
                </div>
              <?php elseif ($validacionesGenerales->getUsuarioPuedeComprarCurso()) : ?>
                <div class="col-4 d-flex align-items-center justify-content-center">
                  ...
                  <!-- <a href="<?php
                                ...
                                ?>" class="btn btn-active-color" style="font-size: 1.1rem;">Video bloqueado hasta comprar curso</a> -->
                </div>
              <?php endif ?>
